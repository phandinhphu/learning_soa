...
import com.example.product.service.AuthValidatorService;
...
public class JwtAuthInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        // Bỏ qua xác thực cho GET /api/products và GET /api/categories
        if ("GET".equals(method) && (path.contains("/api/products") || path.contains("/api/categories"))) {
            return true;
        }
